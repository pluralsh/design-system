...
const SliderWrap = styled.div<SliderWrapProps>(
  ({ theme, percent, size, thumbRadius = 12 }) => ({
    ...
    '.thumb': {
      ...
      borderRadius: '50%',
      background: `radial-gradient(${theme.colors['icon-always-white']} 37%, ${theme.colors['fill-primary']} 40%)`,
      boxShadow: `
    ...
    `,
      ...
      '&.dragging, &.focus': {
        background: `radial-gradient(${theme.colors['icon-always-white']} 37%, ${theme.colors['fill-primary-hover']} 40%)`,
      },
